<template>
  <section class="navbar bg-[#e8ddc5] font-sig py-4 md:py-5">
    <div class="container mx-auto px-4">
      <!-- Desktop + Tablet View (md and up) -->
      <div class="hidden md:flex items-center justify-between space-x-4">
        <!-- Logo -->
        <div class="w-1/5">
          <div class="logo text-xl font-bold"></div>
        </div>
        ...
        <div class="menu w-3/5">
          <div class="flex items-center justify-between flex-nowrap">
            <!-- Menu Links -->
            <ul class="flex items-center flex-nowrap space-x-3 md:space-x-4 lg:space-x-6 font-semibold text-gray-500 text-[14px] md:text-[14px] lg:text-[16px]">
        ...
        <!-- Icons -->
        <ul class="w-1/5 flex justify-end space-x-3 md:space-x-2 lg:space-x-3 text-gray-500 text-[18px] md:text-[13px] lg:text-[18px] ml-0 md:ml-18 lg:ml-0">
