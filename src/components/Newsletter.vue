...
<div class="subscribe_header">
  ...
  <RouterLink><button class="font-sig text-2xl shadow-2xl cursor-pointer py-3 px-10 flex mx-auto mt-10 rounded-[10px] bg-[#dbd0a7e3]">SUBSCRIBE!</button>  </RouterLink> 
    </form>
</div>
</div>
</section>
